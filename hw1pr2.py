...
if __name__ == '__main__':
	...
	"*** YOUR CODE HERE ***"
	y_space_rand=np.add(np.add(np.multiply(X_space,m_opt),b_opt),noise)
	"*** END YOUR CODE HERE ***"
	...
	y_space_rand=y_space_rand.reshape(-1,1)
	X_space_stacked = np.hstack((np.ones_like(y_space_rand),X_space))	
	...
	y_pred_rand = np.add(np.multiply(X_space,m_rand_opt),b_rand_opt)
	"*** END YOUR CODE HERE ***"
